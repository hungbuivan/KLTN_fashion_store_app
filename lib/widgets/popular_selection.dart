      ...
      children: [
        ...
        Padding(
          ...
          child: Row(
            ...
            children: [
              const Text("Sản phẩm phổ biến", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
              GestureDetector(
                onTap: () => Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => const NavigationMenu(selectedIndex: 1))),
                child: Text("Xem tất cả", style: TextStyle(fontSize: 16, color: Theme.of(context).colorScheme.primary)),
              ),
            ],
          ),
        ),
